  ...
  return (
    <div className='unidadDos'>
      ...
      <div className='moverAbajo'>
        ...
        <h2 className='tituloRecordar'>Recordatorios:</h2>
        <div className='recordatorios'>
      <ul>
        <img className='vistoVerde' src="https://i.ibb.co/4pNLdYG/visto1-removebg-preview.png" alt="" />
        <li className='listO'>Recuerda ingresar al campus virtual regularmente para estar al día con los contenidos y las actividades.</li>
        <img className='vistoVerde' src="https://i.ibb.co/4pNLdYG/visto1-removebg-preview.png" alt="" />
        <li className='listO'>Descarga y guarda todo el material importante de las asignaturas antes de que cierren las aulas virtuales.</li>
        <img className='vistoVerde' src="https://i.ibb.co/4pNLdYG/visto1-removebg-preview.png" alt="" />
        <li className='listO'>Consulta periódicamente el plan de estudios de tu carrera para conocer las asignaturas a cursar y sus correlatividades.</li>
        <img className='vistoVerde' src="https://i.ibb.co/4pNLdYG/visto1-removebg-preview.png" alt="" />
        <li className='listO'> Únete al grupo de WhatsApp de primer año de tu carrera para recibir información y novedades relevantes.</li>
      </ul>
    </div>
